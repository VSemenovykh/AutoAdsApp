...
class ListAutoControllerTest {

    @InjectMocks
    ListAutoController listAutoController;

    @Mock
    ListAutoService listAutoService;

    @Test
    public void testGetAllAutoPage() {
        ...
        // when
        ResponseEntity<Map<String, Object>> result = listAutoController.getAllAutoPage(0, 5);
